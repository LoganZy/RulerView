...
public class RulerDateView extends View {
    ...
    public RulerDateView(Context context) {
        this(context, null);
    }

    public RulerDateView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RulerDateView(Context context, AttributeSet attrs, int defStyleAttr) {
